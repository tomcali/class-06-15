...
const edibleArr = arrayOfNotEntirelyEdible.filter(function(maybeEdible){
 return maybeEdible.edible === true;
});

console.log(edibleArr);
...
console.log(groupBouncer(arrayOfCollegeStudents));
...
console.log(individualBouncer(arrayOfCollegeStudents));
